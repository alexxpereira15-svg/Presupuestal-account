...
export default function AnnualSummaryClient({ summary }: { summary: any }) {
  ...
  return (
    <div className="bg-slate-800/30 rounded-2xl border border-slate-800 p-6 space-y-6">
      <div>
        <h3 className="text-xl font-bold text-white">📈 Resumen Anual Total ({summary.year})</h3>
        <p className="text-slate-400 text-xs mt-0.5">Consolidado general de metas y resultados acumulados de los 12 meses</p>
      </div>
